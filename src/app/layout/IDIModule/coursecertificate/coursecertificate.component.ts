...
@Component({
  selector: 'app-coursecertificate',
  templateUrl: './coursecertificate.component.html',
  styleUrls: ['./coursecertificate.component.scss']
})
export class CoursecertificateComponent implements OnInit {
  ...
  public captureScreen() {
    ...
    var position = 0;
    pdf.addImage("assets/images/Certificate2.jpg", 'PNG', 0, position, imgWidth, imgHeight);
    pdf.setFontSize(23);
    pdf.setFont("Arial")
    pdf.setFontType("bold")
    pdf.setTextColor(13, 12, 12);
    pdf.text(115, 114, this.name);
    if (this.course == 'Financial Literacy Skills') {
      ...
      pdf.text(82, 141, this.course);

    }

    pdf.setTextColor(13, 12, 12);

    pdf.text(95, 154, this.grade);
    pdf.setFontSize(18);
    pdf.text(173, 154, this.stdate);
    pdf.text(218, 154, this.endate);
